                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="../img/main_carousel.JPG" alt="Chania">
                            ...
                            <div class="item">
                                <img src="../img/good-kids-room-modern-kids-room-shelf2.jpg" alt="Flower">
                                <div class="carousel-caption">
    ...
    <div class="container">
        <div class="about_us-content">
            ...
            <div class="image-contact col-md-4 col-sm-4 col-xs-6">
                <a href=""><img src="../img/feedback.png" alt=""></a>
            </div>
            <div class="image col-md-3 col-sm-3 col-xs-6" id="image1">
                <a href=""><img src="../img/item_furniture2.jpg" alt=""></a>
            </div>
            ...
            <div class="image col-md-4 col-sm-4 col-xs-6" id="image2">
                <a href=""> <img src="../img/bed_room.jpg" alt=""></a>
            </div>
            <div class="image col-md-4 col-sm-4 col-xs-6" id="image3">
                <a href=""><img src="../img/office_furniture.jpg" alt=""></a>
            </div>
            ...
            <div class="block-content col-md-8 col-sm-8 col-xs-12">
                ...
                <p>
                    Всі <a href="#"><span class="color_word" title="West mebli меблі на замовлення Рівне">кухні-west</span></a> на замовлення виготовляються по індивідуальному проекті, з урахуванням всіх вимог і побажань замовника, розміри меблів, кольори, фурнітура й комплектація.
            ...
            <div class="image col-md-4 col-sm-4 col-xs-6" id="image4" style="margin-top: 40px;">
                <a href=""> <img src="../img/kuhnia-na_zamowlenia.jpg" alt=""></a>
            </div>
        </div>
    </div><!-- end container -->
</section>
