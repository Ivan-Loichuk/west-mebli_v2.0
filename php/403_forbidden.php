<style>
    ...
    #fof .hgroup h1 span strong{display:inline-block; padding:20px 20px 20px; border:1px solid #CCCCCC; font-weight:normal;}
    #fof .hgroup h2{font-size:60px;}
    #fof .hgroup h2 span{display:block; font-size:30px;}
    #fof p{margin:25px 0 0 0; padding:0; font-size:18px;}
  ...
  <div id="container" class="clear">
    ...
    <section id="fof" class="clear">
      ...
      <div class="hgroup">
        ...
        <h2>Помилка! <span></span></h2>
      </div>
      <p>Доступ до файлів заборонено!</p>
      <p><a href="javascript:history.go(-1)">&laquo; Повернутися назад</a> / <a href="http://west-mebli.com.ua/">На головну &raquo;</a></p>
      <!-- ####################################################################################################### -->
    </section>
