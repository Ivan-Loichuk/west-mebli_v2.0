    ...
    <div class="container">
        <div class="about_us-content">
            ...
            <div class="image col-md-3 col-sm-3 col-xs-6" id="image">
                <a href="gallery_view.php?type=cabinets" title="<?php echo $lang->lang_ua['about_us_a_title'][2]?>"><img src="img/item_furniture2.jpg" alt="<?php echo $lang->lang_ua['about_us_img_alt'][1]; ?>" title="<?php echo $lang->lang_ua['about_us_img_title'][1]; ?>"></a>
            </div>
            <div class="block-content  col-md-9 col-sm-9 col-xs-12">
                <div class="title">
                    <a href="gallery_view.php?type=cabinets" title="<?php echo $lang->lang_ua['about_us_a_title'][3]?>"><?php echo $lang->lang_ua['about_us_a'][1]?></a>
                </div>
            ...
            <div class="image col-md-4 col-sm-4 col-xs-6" id="image3">
                <a href="gallery_view.php?type=office" title="<?php echo $lang->lang_ua['about_us_a_title'][6]?>"><img src="img/office_furniture.jpg" alt="<?php echo $lang->lang_ua['about_us_img_alt'][3]; ?>" title="<?php echo $lang->lang_ua['about_us_img_title'][3]; ?>"></a>
            </div>
            <dic class="block-content right col-md-8 col-sm-8 col-xs-12">
                <div class="title">
                    <a href="gallery_view.php?type=office" title="<?php echo $lang->lang_ua['about_us_a_title'][7]?>"><?php echo $lang->lang_ua['about_us_a'][3]?></a>
                </div>
